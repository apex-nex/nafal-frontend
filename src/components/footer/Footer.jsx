              ...
              <Row className="align-items-center">
                ...
                <Col lg={3} md={4} sm={12} xs={12}>
                  <ul className="list-unstyled social-icon foot-social-icon text-sm-end mb-2">
                    <li className="list-inline-item mb-0">
                      <Link
                        to={{ pathname: 'https://www.facebook.com/NAFAL.HVAC' }}
                        target="_blank"
                    ...
                    <li className="list-inline-item mb-0">
                      <Link
                        to={{ pathname: 'https://www.instagram.com/nafal.hvac/' }}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="rounded"
                      >
                    ...
                    <li className="list-inline-item mb-0">
                      <Link
                        to={{ pathname: 'https://twitter.com/NAFALHVAC' }}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="rounded"
                      >
                    ...
                    <li className="list-inline-item mb-0">
                      <Link
                        to={{ pathname: 'https://www.linkedin.com/in/nafal-hvac-6937472a1' }}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="rounded"
                      >
                    ...
                    <li className="list-inline-item mb-0">
                      <Link
                        to={{ pathname: 'https://www.snapchat.com/add/nafal.hvac' }}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="rounded"
                      >
                    ...
                    <li className="list-inline-item mb-0">
                      <Link
                        to={{ pathname: 'https://www.youtube.com/channel/UCt4ij1e-w2XfbUtfTptwfKQ' }}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="rounded"
                      >
