const termsContentArabic = {
    ...
    welcome: {
        title: "مرحبا بكم في نفال للتكييف :",
        content: "اكتشف أفضل خدمات تكييف الهواء في نفال للتكييف. نحن ملتزمون بتوفير حلول راحة لا مثيل لها لمساحاتك الداخلية.",
    },
    commitment: {
        title: "التزامنا بالخدمة :",
        content: "في شركة نفال للتكييف، نتعهد بتقديم خدمات تكييف الهواء الموثوقة والفعالة، والمصممة خصيصًا لتلبية احتياجاتك الفريدة. التزامنا الثابت هو تحسين أداء وعمر أنظمة تكييف الهواء (HVAC)، مما يضمن راحتك الداخلية طوال العام.",
    },
    restrictions: {
        title: "قيود الخدمة :",
